...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title)]); ?>
    ...
    <header class="sticky top-0 z-30 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div class="mx-auto flex h-16 max-w-6xl items-center gap-4 px-4">
            <a href="<?php echo e(route('catalog')); ?>" class="flex items-center gap-2" data-testid="brand-link">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2511592866-0', $__key);
            ...
            <nav class="ml-auto hidden items-center gap-1 md:flex">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route($item['route'])); ?>" wire:navigate
                       class="relative flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition <?php echo e($item['active'] ? 'bg-brand-light text-brand-dark' : 'text-slate-600 hover:bg-slate-100'); ?>"
                       data-testid="desktop-nav-<?php echo e($item['route']); ?>">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => $item['icon'],'class' => 'h-4 w-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['route'] === 'cart'): ?> <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('buyer.cart-badge', []);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2511592866-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2511592866-2', $__key);
...
<?php unset($__componentOriginal3c7b84510759e52dbc6ba1a22c2f942e); ?>
<?php endif; ?>
                <span class="text-sm text-slate-500"><?php echo e($user->name); ?></span>
                <span class="grid h-9 w-9 place-items-center rounded-full bg-accent/15 text-sm font-bold text-accent"><?php echo e($user->initials()); ?></span>
            </div>
        </div>
    </header>
...
<?php endif; ?>
    ...
    <nav class="safe-bottom fixed inset-x-0 bottom-0 z-30 border-t border-slate-200 bg-white md:hidden">
        <div class="grid grid-cols-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route($item['route'])); ?>" wire:navigate
                   class="relative flex flex-col items-center gap-1 py-2.5 text-[11px] font-semibold <?php echo e($item['active'] ? 'text-brand' : 'text-slate-500'); ?>"
...
[$__name, $__params] = $__split('buyer.cart-badge', ['position' => 'absolute']);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2511592866-3', $__key);
...
<?php endif; ?>
<?php /**PATH /Users/mac/Herd/kantinsmk-go/resources/views/components/layouts/app.blade.php ENDPATH**/ ?>