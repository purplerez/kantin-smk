{{-- Tombol bunyi on/off (preferensi disimpan di localStorage browser) --}}
<button type="button"
        ...
        {{ $attributes->merge(['class' => 'grid h-9 w-9 place-items-center rounded-full text-slate-500 hover:bg-slate-100', 'data-testid' => 'sound-toggle']) }}>
